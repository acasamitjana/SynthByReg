...
from src.training import InfoNCE3D
...
# Discriminator
discriminator_M = models.NLayerDiscriminator3D(
    input_nc=1, ndf=16, n_layers=3,
    norm_layer=functools.partial(nn.InstanceNorm3d, affine=False, track_running_stats=False),
...
training_session = InfoNCE3D(device, loss_function_dict, lambda_weight_dict, callback_list, da_model, nce_layers,
