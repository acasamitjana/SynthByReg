...
from src.training import InfoNCE2DNoGAN
...
kwargs_training = {'log_interval': parameter_dict['LOG_INTERVAL'], 'weakly_flag': False, 'bidir_flag': True}  # Number of steps
kwargs_testing = {}
...
training_session = InfoNCE2DNoGAN(device, loss_function_dict, lambda_weight_dict, callback_list, da_model, nce_layers,
