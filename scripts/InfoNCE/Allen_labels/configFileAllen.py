...
CONFIG = {
    ...
    'PARENT_DIRECTORY': 'DEF/2_NCE_SIGMOID'
}
...
CONFIG_RoT = copy.copy(CONFIG)
CONFIG_RoT['PARENT_DIRECTORY'] += '/RoT'
CONFIG_RoT['RESULTS_DIR'] = join(BASE_DIR, CONFIG_RoT['PARENT_DIRECTORY'], '')
