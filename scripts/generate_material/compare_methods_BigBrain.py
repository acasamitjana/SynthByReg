...
rid_list = ["{:03d}".format(i) for i in range(20, 351)]
...
############ PARAMETERS ############
####################################
RESULTS_DIR = '/home/acasamitjana/Results/RegSyn/BigBrain/results'
model_ckp_list = {
    'NMI': '/home/acasamitjana/Results/RegSyn/BigBrain/Registration/MRI_HISTO_NMI/D2_R1_S1/sigmoid_bidir_3neigh_noDA/checkpoints/model_checkpoint.FI.pth',
    'RoT': '/home/acasamitjana/Results/RegSyn/BigBrain/InfoNCE/DEF/2_NCE_SIGMOID/RoT/HISTO__RL1_RS1_G1/checkpoints/model_checkpoint.FI.pth',
    'cGAN': '/home/acasamitjana/Results/RegSyn/BigBrain/CycleGAN/2_NCE_SIGMOID/HISTO_R1_RS1_C1_G1/checkpoints/model_checkpoint.FI.pth',
    'SbR-N': '/home/acasamitjana/Results/RegSyn/BigBrain/InfoNCE/DEF/2_NCE_SIGMOID/HISTO_reg__RL1.0_RN0.0_RS0.0_N0.0_G0.0_T0.0/checkpoints/model_checkpoint.FI.pth',
    'SbR': '/home/acasamitjana/Results/RegSyn/BigBrain/InfoNCE/DEF/2_NCE_SIGMOID/HISTO_reg__RL1.0_RN0.0_RS0.0_N0.02_G0.0_T0.05/checkpoints/model_checkpoint.FI.pth',
    'SbR-R': '/home/acasamitjana/Results/RegSyn/BigBrain/InfoNCE/DEF/2_NCE_SIGMOID/REFINE/HISTO_reg__RL1.0_RN0.0_RS1.0_N0.02_G0.0_T0.05_E0_higherLR/HISTO_reg__RL1.0_RN0.0_RS0.0_N0.02_G0.0_T0.05/checkpoints/model_checkpoint.LAST.pth',
    'SbR-G': '/home/acasamitjana/Results/RegSyn/BigBrain/InfoNCE/DEF/2_NCE_SIGMOID/HISTO_reg__RL1.0_RN0.0_RS0.0_N0.02_G1_T0.05/checkpoints/model_checkpoint.FI.pth',
}
...
for reg_type, weightsfile in model_ckp_list.items():
    ...
    for batch_idx, data_dict in enumerate(generator_test):
        ...
        rid = data_dict['rid'][0]
        print(str(batch_idx) + '/' + str(len(generator_test)) + '. Slice: ' + str(rid))
        ...
        if 'SbR' in reg_type or 'GAN' in reg_type:
            output_results = evaluate_class.evaluate_rbs(data_dict, model_dict, device,
                                                 ...
                                                 init_image_shape=data_loader.subject_dict[rid].image_shape)
    ...
    plt.grid()
    plt.legend()
    plt.title('GM_LL Init: ' + str(np.round(np.mean([m for m in total_init_dice_1 if m>0]),2)) + '. Dice GM_LL Fi: ' + str(np.round(np.mean([m for m in total_fi_dice_1 if m>0]),2)))
