...
arg_parser.add_argument('--lreg'),
arg_parser.add_argument('--lsmooth'),
arg_parser.add_argument('--loss', ),

arguments = arg_parser.parse_args()
stain_flag = arguments.stain
# lreg = arguments.lreg
# lsmooth = arguments.lsmooth
# loss = arguments.loss
...
# parameter_dict['LOSS_REGISTRATION'] = loss
# parameter_dict['LAMBDA_REGISTRATION'] = float(lreg)
# parameter_dict['LAMBDA_SMOOTHNESS'] = float(lsmooth)
...
# Losses
loss_registration = losses.DICT_LOSSES[parameter_dict['LOSS_REGISTRATION']]
loss_function_dict = {
    'registration': loss_registration(device=device, win=parameter_dict['NCC_WINDOW'], name='registration'),
    'registration_smoothness': losses.Grad_Loss(dim=2, penalty='l2', loss_mult=parameter_dict['UPSAMPLE_LEVELS'],)
}
loss_weight_dict = {
    'registration': parameter_dict['LAMBDA_REGISTRATION'],
    'registration_smoothness': parameter_dict['LAMBDA_SMOOTHNESS']
}
