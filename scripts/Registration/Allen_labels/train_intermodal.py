...
from src.training import Registration, WeaklyRegistration
...
bidir_flag = False#False if stain_flag != 'MRI' else True
mask_flag = True
...
if labels_flag:
    loss_labels = losses.DICT_LOSSES[parameter_dict['LOSS_LABELS']['name']]
    loss_function_dict['registration_labels'] = loss_labels(name='registration_labels', **parameter_dict['LOSS_LABELS']['params'])
    loss_weight_dict['registration_labels'] = parameter_dict['LOSS_LABELS']['lambda']
