...
BASE_DIR = '/home/acasamitjana/Results/RegSyn/Allen_labels/Registration'
...
CONFIG = {
    ...
    'ROTATION': AffineParams(rotation=[3]*2, scaling=[0.05]*2, translation=[2]*2),
    ...
    'UPSAMPLE_LEVELS': 2,
    'FIELD_TYPE': 'velocity',
    'DISTANCE_NEIGHBOURS': 2,

}

CONFIG['RESULTS_DIR'] = join(BASE_DIR, 'MRI_ROT_' + CONFIG['LOSS_REGISTRATION']['name'],
...
CONFIG_INTERMODAL_NR = copy.copy(CONFIG)
CONFIG_INTERMODAL_NR['RESULTS_DIR'] = join(BASE_DIR, 'NiftyReg')